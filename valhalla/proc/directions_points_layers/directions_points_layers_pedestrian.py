...
class ValhallaRoutePointsLayersPedestrianAlgo(ValhallaRoutePointsLayersCarAlgo):

    ALGO_NAME = 'directions_from_points_2_layers_pedestrian'
    ...
    def createInstance(self):
        return ValhallaRoutePointsLayersPedestrianAlgo()
