...
from valhalla_qgis_plugin.common import AUTO_COSTING, TRUCK_COSTING, BICYCLE_COSTING, PED_COSTING, BICYCLE_TYPES

class CostingAuto():

    def set_costing_options(self, proc_algo, parameters, context):
        """
        Sets the costing options from the Processing algo params.
    ...
    def get_costing_params():
        """
        Returns the processing algo definition for the costing parameters.

        :return: list of processing parameter definitions
        :rtype: list of any
        """
        costings = []
